return {
 ...
 --    ANNOUNCE_GHOSTLYBOND_LEVELUP = 
	...
	ANNOUNCE_WORMS = "Uh-oh. I think I should leave.",
	ANNOUNCE_CRAFTING_FAIL = "I lack the necessary materials.",
	ANNOUNCE_DUSK = "Darkness will be here soon. I must prepare.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Yum!",
	...
	ANNOUNCE_NO_TRAP = "Something finally went right.",
	...
	ANNOUNCE_UNIMPLEMENTED = "Oh! I think it needs some more time.",
	...
	ANNOUNCE_PUGALISK_INVULNERABLE = {"Sigh. It didn't work.", "Why do I bother?", "No use trying to break it there."}, --> NEW
	...
	DESCRIBE =
	{
		...
		SLURTLEHAT="It certainly didn't help its original owner.",
		...
		FISH_MED = "It has shed its earthly tether.",
		...
		MANDRAKE =
		{
			...
			PICKED = "Onward, my vegetable minion!",
		},
		...
		MARBLETREE = "There is no thrum of life within this cold tree.",
		MARSH_BUSH =
		{
		...
		PLANT_NORMAL =
		{
			...
			WITHERED = "Its had the life sucked out of it.",
		},
		...
		CLOTHSAIL = "With sail in hand I shall beat a hasty escape. But to where?",
		COCONADE = "A coconut filled with hot, fiery death.",
		COCONUT = 
		{
		    GENERIC = "What secrets must this fruit hide beneath its armor?",
		    PLANTED = "I was expecting a darker secret.",
		},
		COFFEE = "Dark. Bitter...",
		...
		CORALREEF = "The coral grows to escape the sea.",
		...
		DEAD_SWORDFISH = "Its sword face couldn't save it...",
		...
		FEATHERSAIL = "Those dumb birds sure make a speedy sail.",
		...
		JUNGLETREESEED =
        {
            GENERIC = "It's a parcel of potential.",
            PLANTED = "There's no going back, now.",
        },
		LAVAPOOL = "This pool churns with the volcano's anger!",
		LIMESTONE = "When coral dies it hardens into stone.",
		...
		RAFT = "Perhaps if I ride upon the waves I shall join my sister.",
		ROWBOAT = "I wonder how many leagues this can convey me?",
		SAIL = "Harness the wind and fly to... nowhere.",
		...
		SANDHILL = "This looks impermanent.",
		...
		TRINKET_13 = "Maybe if I drank this stuff I'd return to my sister.",
		TRINKET_14 = "If I pushed a pin into this doll, who would feel it?",
		TRINKET_15 = "Whoever this belonged to isn't walking anymore.",
		TRINKET_16 = "Whatever this belonged to met a bad end.",
		TRINKET_17 = "Whoever wore this is surely dead.",
		TRINKET_18 = "A remnant of a civilization lost at sea.",
		TRINKET_19 = "The owner's brain has surely clouded for good by now.",
		...
		BEEMINE_MAXWELL = "The furious creatures within appreciate their freedom in retrospect.",
		...
		DEVTOOL = "It has a strong smell.",
		DEVTOOL_NODEV = "I can't use that.",
		...
		FISH_RAW = "It's been decapitated.",
		FISH_RAW_SMALL = "There are other fish in the sea. Bigger ones, hopefully.",
		FISH_RAW_SMALL_COOKED = "It will... tide... me over for now.",
		...
		HOME = "Not exactly picket fence material.",
		HOUNDFIRE = "It burns!",
		ICEMAKER =
		{
		...
		REDBARREL = "This is a safety hazard. Good.",
		RUBBLE = "This crushed stone is useless.",
		...
		TRINKET_20 = "I just use it as a paperweight.",
		TRINKET_21 = "What sort of simple mind would be amused by this?",
		TRINKET_22 = "Very DIY.",
		TRINKET_23 = "How unfortunate.",
		TROPICAL_FISH = "It's offensively bright.",
		TUNACAN = "This is plainly false advertising.",
		TURF_ASH = "It's just ground.",
		TURF_DESERTDIRT = "It's just ground.",
		TURF_FUNGUS_GREEN = "It's just ground.",
		TURF_FUNGUS_RED = "It's just ground.",
		...
		WOODLEGSBOAT = "A seaworthy vessel if ever there was one!",
		WOODLEGSHAT = "Haughty seadog couture.",
		WOODLEGSSAIL = "I adore the design.",
		...
		WORMHOLE_LIMITED = "It's looking downtrodden.",
		WRECK = "Its crew is probably dead...",

		--- 5C DLC ------------------------------------------------------------------------------------------------

        ENCRUSTEDBOAT = "A vessel of aquatic death.",
        ...
        FISH3 = "A pitiful creature.",
        FISH4 = "The stripes symbolize its emotional imprisonment.",
        FISH5 = "It misses its watery home.",

        FISH3_COOKED = "Rest now, fish spirit.",
        FISH4_COOKED = "Don't lose your head.",
        FISH5_COOKED = "I've... eaten worse...",
	...
	EAT_FOOD =
	{
		TALLBIRDEGG_CRACKED = "It never even got to see the world.",
	},
}
