...
local actionhandlers = 
{
	...
	-- 		return action.invobject ~= nil and action.invobject:HasTag("abby_flower") and "summon_abigail" or "castspell"
	-- 	end),
...
local states= 
{
	...
	State
	{
		...
		if inst.bufferedaction ~= nil then
			...
			inst.components.talker:Say(GetString(inst.prefab, "ANNOUNCE_ABIGAIL_RETRIEVE"), nil, nil, true)
		end
	end,
